  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
        ...
        >
          <p className="text-[#a68038] dark:text-[#c8a96e] text-xs tracking-[0.25em] uppercase mb-3">
            What We Stand For
          </p>
          <h2
          ...
          <div className="relative grid lg:grid-cols-2 gap-5">
            ...
            {TIMELINE.map((item, i) => (
              ...
              >
                ...
                >
                  <span
                    className="text-[#a68038] dark:text-[#c8a96e] font-black text-sm"
                    style={{ fontFamily: "'Georgia', serif" }}
                  >
                    {item.year}
                  </span>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-[#a68038] dark:text-[#c8a96e] text-xs tracking-[0.25em] uppercase mb-4">
                Visit Us
              </p>
              <h2
                ...
                {[
                  ...
                  >
                    <span className="text-lg mt-0.5 shrink-0">
                      <item.Icon className="w-6 h-6 text-[#a68038] dark:text-[#c8a96e]" />
                    </span>
                    <div>
                      ...
                      {item.href ? (
                        <a
                          href={item.href}
                          className="text-foreground/60 hover:text-[#a68038] dark:text-[#c8a96e] transition-colors text-sm"
                        >
                          {item.value}
                        </a>
                      ) : (
