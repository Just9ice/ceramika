      ...
      <section className="relative bg-[#25d366]/[0.12] py-28 overflow-hidden border-t border-border">
        ...
        <div className="relative max-w-md mx-auto text-center px-4">
          ...
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 bg-[#25d366] hover:bg-[#1fb859] text-foreground font-black px-8 py-4 rounded-full text-sm text-white/85 transition-colors duration-200"
            variants={fadeUp}
            custom={2}
            initial="hidden"
            whileInView="show"
