  ...
  <>
   ...
   >
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-16 grid lg:grid-cols-2 gap-12 items-center w-full">
     ...
     <div>
      <motion.p
       className="text-[#a68038] text-xs tracking-[0.32em] uppercase mb-5"
      ...
      >
       ...
       <span className="text-transparent [-webkit-text-stroke:2px_#a68038] ,169,110,0.55)]">Walls.</span><br />
      ...
      <div className="relative flex justify-end max-w-[420px] ml-auto">
       ...
       >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5">
         ...
         <p className="text-[#a68038] text-xs">₦18,500/sqm</p>
        </div>
        {/* Top glow */}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
     <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/5">
      {STATS.map(({ value, label }, i) => (
       ...
       >
        <span
         className="font-black text-[#a68038] group-hover:scale-105 transition-transform duration-300"
   ...
   <section className="bg-background py-20">
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
     <motion.div
      ...
      transition={{ duration: 0.6, ease }}
     >
      <p className="text-[#a68038] text-xs tracking-[0.3em] uppercase mb-3">Shop by Category</p>
      <div className="flex items-end justify-between">
       ...
       >
        Explore Our<br />
        <span className="text-transparent [-webkit-text-stroke:1.5px_#a68038] ,169,110,0.45)]">
         Collections.
        </span>
       </h2>
       <Link href="/shop" className="text-foreground/ hover:text-[#a68038] text-sm transition-colors hidden sm:block">
        View all →
       </Link>
      </div>
     </motion.div>
   ...
   <section id="products" ref={productsRef} className="bg-muted/30 py-20 border-t border-border">
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
     ...
     >
      <div>
       <p className="text-[#a68038] text-xs tracking-[0.3em] uppercase mb-3">Our Collection</p>
       <h2
        className="text-foreground font-black"
        style={{ fontFamily: "'Georgia', serif", fontSize: 'clamp(1.8rem, 4vw, 3rem)' }}
       >
      ...
      <Link
       href="/shop"
       className="text-foreground/ hover:text-[#a68038] text-sm transition-colors hidden sm:flex items-center gap-1"
      >
       Browse all tiles <span className="text-[#a68038] ">→</span>
      </Link>
     </motion.div>
     ...
     >
      <Link
       href="/shop"
       className="inline-flex items-center gap-2 border border-border hover:border-[#a68038] text-foreground/ hover:text-[#a68038] px-8 py-3 rounded-full text-sm transition-all duration-200 sm:hidden"
      >
       View all tiles →
      </Link>
     </motion.div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
     <div className="grid lg:grid-cols-[1fr_1.2fr] gap-16 items-center">
      ...
      >
       ...
       >
        SqM &amp; Cost<br />
        <span className="text-transparent [-webkit-text-stroke:1.5px_#a68038] ,169,110,0.45)]">Calculator.</span>
       </h2>
   ...
   <section className="bg-muted/30 py-24">
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
     <motion.div
      ...
      transition={{ duration: 0.6, ease }}
     >
      <p className="text-[#a68038] text-xs tracking-[0.3em] uppercase mb-3">Customer Reviews</p>
