    ...
    return (
        <section className="bg-muted/20 border-t border-border py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                >
                    <p className="text-[#a68038] dark:text-[#c8a96e] text-xs tracking-[0.2em] uppercase mb-3">
                        Common Questions
                    </p>
                    <h2
                        ...
                        return (
                            <motion.div
                                ...
                                className={`group relative overflow-hidden rounded-3xl border cursor-pointer
                                    ...
                                    ${isOpen
                                        ? "border-[#a68038] dark:border-[#c8a96e]/40 bg-card"
        ...
        <div className="min-h-screen bg-background overflow-x-hidden">
                        ...
                        >
                            {[
                                ...
                                <div key={s.label} className="text-center lg:text-left">
                                    <div
                                        className="font-black text-3xl text-[#a68038] dark:text-[#c8a96e]"
                                        style={{ fontFamily: "'Georgia', serif" }}
                                    >
                                        {s.value}
                                    </div>
            ...
            <section className="relative border-y border-border py-20 overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
                    <motion.div
                        ...
                        viewport={{ once: true, margin: "-60px" }}
                    >
                        <p className="text-[#a68038] dark:text-[#c8a96e] text-xs tracking-[0.25em] uppercase mb-3">Process</p>
                        <h2
                    ...
                    <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        {[
                            ...
                            >
                                {/* Step bubble */}
                                <div
                                    className="relative w-16 h-16 rounded-full border border-[#a68038] dark:border-[#c8a96e]/20 flex items-center justify-center mb-5 shrink-0"
                                    style={{ background: "rgba(200,169,110,0.06)" }}
                                >
                                    <span
                                        className="font-black text-sm text-[#a68038] dark:text-[#c8a96e]"
                                        style={{ fontFamily: "'Georgia', serif" }}
                                    >
                                        {item.step}
                                    </span>
                                    {/* outer ring */}
                                    <div className="absolute inset-[-6px] rounded-full border border-[#a68038] dark:border-[#c8a96e]/08" />
                                </div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
                <motion.div
                    ...
                    viewport={{ once: true, margin: "-60px" }}
                >
                    <p className="text-[#a68038] dark:text-[#c8a96e] text-xs tracking-[0.25em] uppercase mb-3">Options</p>
                    <h2
                        className="text-foreground font-black text-4xl"
                                ...
                                <ul className="flex flex-col gap-2.5">
                                    {opt.details.map((d) => (
                                        <li key={d} className="flex gap-2.5 text-xs text-muted-foreground leading-relaxed">
                                            <span className="text-[#a68038] dark:text-[#c8a96e]/60 shrink-0 mt-0.5">✓</span>
                                            {d}
                                        </li>
                                    ))}
                                </ul>
                ...
                {/* Timeline disclaimer */}
                <motion.div
                    className="mt-6 flex gap-3 rounded-2xl border border-[#a68038] dark:border-[#c8a96e]/12 bg-[#c8a96e]/[0.04] p-5"
                    variants={fadeUp}
                    initial="hidden"
                    whileInView="show"
                    viewport={{ once: true }}
                >
                    <span className="text-[#a68038] dark:text-[#c8a96e]/50 shrink-0 mt-0.5 text-base">ℹ</span>
                    <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true, margin: "-60px" }}
                        >
                            <p className="text-[#a68038] dark:text-[#c8a96e] text-xs tracking-[0.25em] uppercase mb-4">How We Pack</p>
                            <h2
                            ...
                            <ul className="flex flex-col gap-3.5">
                                {[
                                    ...
                                    >
                                        <span
                                            className="shrink-0 w-5 h-5 rounded-full border border-[#a68038] dark:border-[#c8a96e]/20 flex items-center justify-center mt-0.5"
                                            style={{ background: "rgba(200,169,110,0.06)" }}
                                        >
                                            <span className="text-[#a68038] dark:text-[#c8a96e] text-[9px]">✓</span>
                                        </span>
                                        {item}
                                    </motion.li>
                                ))}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                >
                                    ...
                                    />
                                    <div
                                        className="text-[#a68038] dark:text-[#c8a96e] font-black text-4xl mb-1"
                                        style={{ fontFamily: "'Georgia', serif" }}
                                    >
                                        {s.stat}
                                    </div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
                <motion.div
                    ...
                    viewport={{ once: true, margin: "-60px" }}
                >
                    <p className="text-[#a68038] dark:text-[#c8a96e] text-xs tracking-[0.25em] uppercase mb-3">Coverage</p>
                    <h2
                        className="text-foreground font-black text-4xl"
                        style={{ fontFamily: "'Georgia', serif" }}
                    >
                    ...
                    {STATES.map((state) => (
                        <motion.span
                            ...
                            className={`text-xs px-3 py-1.5 rounded-full border transition-colors duration-200 ${state === "Lagos"
                                    ? "bg-[#c8a96e]/10 border-[#a68038] dark:border-[#c8a96e]/30 text-[#a68038] dark:text-[#c8a96e] font-semibold"
                                    : state === "FCT (Abuja)"
                                        ? "bg-[#c8a96e]/05 border-[#a68038] dark:border-[#c8a96e]/20 text-[#a68038] dark:text-[#c8a96e]/70"
