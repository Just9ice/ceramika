        ...
        return (
            ...
            >
                <div className="text-center">
                    ...
                    <Link href="/by-room" className="text-[#a68038] dark:text-[#c8a96e] hover:underline text-sm">
                        ← Browse All Tiles
                    </Link>
                </div>
            </div>
        ...
        <div className="min-h-screen bg-[#0f1a12]">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16">
                ...
                <nav className="flex items-center gap-2 text-xs mb-8 text-white/25">
                    <Link href="/" className="hover:text-[#a68038] dark:text-[#c8a96e] transition-colors">Home</Link>
                    <span className="text-white/10">/</span>
                    <Link href="/by-room" className="hover:text-[#a68038] dark:text-[#c8a96e] transition-colors">By Room</Link>
                    <span className="text-white/10">/</span>
                    <Link href={`/by-room?filter=${product.room.toLowerCase()}`} className="hover:text-[#a68038] dark:text-[#c8a96e] transition-colors">{product.room}</Link>
                    <span className="text-white/10">/</span>
                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-16">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {[
                                ...
                                <div
                                    key={i}
                                    className={`relative h-16 rounded-lg bg-gradient-to-br ${item.bg} border border-white/10 cursor-pointer hover:border-[#a68038] dark:border-[#c8a96e]/40 transition-colors overflow-hidden`}
                                >
                                    {item.img && (
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="mb-6">
                            <span
                                className="text-[#a68038] dark:text-[#c8a96e] font-black"
                                style={{
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        className="w-16 text-center bg-white/5 border border-white/10 rounded-lg px-2 py-1.5 text-white text-sm font-semibold text-center focus:outline-none focus:border-[#a68038] dark:border-[#c8a96e]/40"
                                    />
                                    <button
                            ...
                            <div className="text-[#a68038] dark:text-[#c8a96e]/60 text-sm font-semibold">
                        ...
                        {(["details", "calculator", "delivery"] as const).map((tab) => (
                            <button
                                ...
                                className={`px-6 py-3.5 text-sm font-semibold capitalize border-b-2 transition-all ${activeTab === tab
                                    ? "border-[#a68038] dark:border-[#c8a96e] text-[#a68038] dark:text-[#c8a96e]"
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-16">
                        ...
                        <div>
                            ...
                            <ul className="flex flex-col gap-3 text-sm text-white/45 leading-relaxed">
                                <li className="flex gap-2"><span className="text-[#a68038] dark:text-[#c8a96e] shrink-0">✓</span> Sweep or vacuum regularly to remove grit and dust.</li>
                                <li className="flex gap-2"><span className="text-[#a68038] dark:text-[#c8a96e] shrink-0">✓</span> Mop with a pH-neutral cleaner — avoid harsh acids or bleach.</li>
                                <li className="flex gap-2"><span className="text-[#a68038] dark:text-[#c8a96e] shrink-0">✓</span> Wipe spills immediately to prevent staining.</li>
                                <li className="flex gap-2"><span className="text-[#a68038] dark:text-[#c8a96e] shrink-0">✓</span> Use felt pads under furniture to prevent scratching.</li>
                                {product.material === "Marble" || product.material === "Granite" ? (
                                    <li className="flex gap-2"><span className="text-[#a68038] dark:text-[#c8a96e] shrink-0">✓</span> Seal annually with a penetrating stone sealer.</li>
                                ) : null}
                            </ul>
                        </div>
                    </div>
                ...
                {activeTab === "calculator" && (
                    <div className="max-w-lg mb-16">
                            ...
                            {[
                                ...
                                <div key={f.label}>
                                    ...
                                    <input
                                        ...
                                        placeholder={f.ph}
                                        className="w-full bg-[#141e16] border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/20 focus:outline-none focus:border-[#a68038] dark:border-[#c8a96e]/40 text-sm"
                                    />
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="bg-[#141e16] border border-white/5 rounded-xl p-3 mb-4 text-sm">
                            ...
                            <span className="text-[#a68038] dark:text-[#c8a96e] ml-2 font-bold">₦{product.pricePerSqm.toLocaleString()}/sqm</span>
                        </div>
                        ...
                        {calcRes && (
                            <div className="grid grid-cols-2 gap-3 mb-6">
                                {[
                                    ...
                                    <div
                                        key={r.label}
                                        className={`rounded-xl p-4 ${r.hi ? "bg-[#c8a96e]/10 border border-[#a68038] dark:border-[#c8a96e]/20" : "bg-[#141e16] border border-white/5"
                                            }`}
                                    >
                                        <p className="text-white/30 text-xs mb-1">{r.label}</p>
                                        <p className={`font-black text-lg ${r.hi ? "text-[#a68038] dark:text-[#c8a96e]" : "text-white"}`}>{r.value}</p>
                                    </div>
                                ))}
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 mb-16 max-w-2xl">
                        {[
                            ...
                            <div key={d.title} className="bg-[#141e16] border border-white/5 rounded-xl p-5">
                                <div className="mb-3"><d.Icon className="w-6 h-6 text-[#a68038] dark:text-[#c8a96e]" /></div>
                                <h4 className="text-white font-bold text-sm">{d.title}</h4>
                                <p className="text-[#a68038] dark:text-[#c8a96e] text-sm font-semibold mt-0.5 mb-2">{d.detail}</p>
