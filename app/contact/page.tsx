    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <motion.p
            className="text-[#a68038] text-xs tracking-[0.3em] uppercase mb-4"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="grid lg:grid-cols-[1fr_360px] gap-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-[#a68038] text-xs tracking-[0.25em] uppercase mb-3">Send Enquiry</p>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-sm text-[#a68038] border border-[#a68038] rounded-full px-5 py-2 hover:bg-[#c8a96e]/10 transition-colors"
                  >
                ...
                >
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-card border border-border focus:border-[#a68038] rounded-xl px-4 py-3.5 text-foreground placeholder-muted-foreground/50 text-sm focus:outline-none transition-colors"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-card border border-border focus:border-[#a68038] rounded-xl px-4 py-3.5 text-foreground/70 text-sm focus:outline-none appearance-none"
                      >
                  ...
                  <div>
                    <label className="text-muted-foreground text-xs uppercase tracking-widest block mb-2">
                      Message <span className="text-[#a68038] ">*</span>
                    </label>
                    <textarea
                      name="message" value={form.message} onChange={handleChange}
                      placeholder="Tell us about your project, the tiles you're interested in, or your questions…"
                      required rows={5}
                      className="w-full bg-card border border-border focus:border-[#a68038] rounded-xl px-4 py-3.5 text-foreground placeholder-muted-foreground/50 text-sm focus:outline-none transition-colors resize-none"
                    />
                  </div>
                  <motion.button
                    type="submit"
                  ...
                  <p className="text-muted-foreground/70 text-xs">
                    Submitting opens WhatsApp with your message pre-filled. Fields marked <span className="text-[#a68038] ">*</span> are required.
                  </p>
                </motion.form>
              )}
            </AnimatePresence>
          ...
          <div className="flex flex-col gap-5">
              ...
              >
                ...
                <div className="relative text-center">
                  ...
                  <a
                    ...
                    className="inline-block mt-3 text-xs text-[#a68038] border border-[#a68038] rounded-full px-4 py-1.5 hover:bg-[#c8a96e]/10 transition-colors"
                  >
                    Open in Maps →
                  </a>
                </div>
            ...
            {/* Trade */}
            <motion.div
              className="bg-[#c8a96e]/[0.05] border border-[#a68038] rounded-3xl p-5"
              variants={fadeUp}
              custom={3}
              initial="hidden"
              whileInView="show"
              viewport={{ once: true }}
            >
              <p className="text-[#a68038] text-xs uppercase tracking-widest mb-2 font-semibold">Trade & Bulk Orders</p>
              ...
              <a
                ...
                target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-[#a68038] text-sm font-bold hover:text-[#d4b87e] transition-colors"
              >
                <WhatsAppIcon className="w-4 h-4" />
